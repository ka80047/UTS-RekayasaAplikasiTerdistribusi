...
class Client(object):
    ...
    def btn_connect_clicked(self):
        ...
        if len(port) == 0:
            ...
            try:
                ...
                print("[STATUS]", error)
                self.show_error("Port error", error)
        ...
        if self.connect(host, port, nickname):
            ...
            print("[STATUS] recv thread dimulai")
    ...
    def connect(self, host, port, nickname):
        ...
        try:
            ...
            print("[STATUS] Telah terhubung ke Server!")

            return True
        except Exception as e:
            error = "Tidak dapat terhubung ke server \n'{}'".format(str(e))
            print("[STATUS]", error)
            self.show_error("Koneksi Bermasalah", error)
    ...
    def send_message(self):
        ...
        self.chat_ui.textBrowser.append("Anda: " + message)
        ...
        try:
            ...
            error = "Tidak dapat mengirim pesan '{}'".format(str(e))
            print("[STATUS]", error)
            self.show_error("Server Bermasalah", error)
