...
class Server(object):
    def __init__(self, hostname, port):
        ...
        print("[STATUS] Server terhubung")
        print("[STATUS] Server Berjalan di {} dengan port {}".format(hostname, port))
        print("[STATUS] Silahkan menjalankan client.py dengan hostname dan port yang tertera diatas")
        ...
        while True:
            ...
            print("[STATUS] Koneksi Dari {}:{} AKA {}".format(address[0], address[1], nickname))


    def receive_message(self, connection, nickname):
        print("[STATUS] Menunggu Pesan")
        while True:
            try:
